...
#Visualización de tabla de contingencia
  ...
  # Promedio de Gobierno según confianza en el Ingresos
  tapply(proc_data$conf_gob, proc_data$ingresos, mean)
  
  # Promedio de Carabineros según confianza en Ingresos
  tapply(proc_data$conf_car, proc_data$ingresos, mean)
  
  # Promedio de Poder Judicial según confianza en Ingresos
  tapply(proc_data$conf_poder_judicial, proc_data$ingresos, mean)
  
  # Promedio de Instituciones según confianza en Ingresos
  tapply(proc_data$conf_inst, proc_data$ingresos, mean)
  ...
  proc_data <- elsoc_long_2016_2023 %>% 
    filter(ola == ola_w05)  # Asumiendo que la columna se llama "ola"
