...
save(proc_data,file = "C:/Users/Mati/OneDrive/Escritorio/Trabajo Astorga Hermosilla y Pavez/elsoc_long_2016_2023.RData")

# 6.2 Guardar la base de datos procesada
save(proc_data,file = "C:/Users/Mati/OneDrive/Escritorio/Trabajo Astorga Hermosilla y Pavez/Trabajo1/procesamiento/elsoc_proc.RData")
